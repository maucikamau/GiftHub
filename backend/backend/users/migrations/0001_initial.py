...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_access_update_role', 'Can access update role'), ('can_access_update_type', 'Can access update type'), ('can_access_basic_info', 'Can access basic info'), ('can_access_udruga_additional_info', 'Can access udruga additional info')],
            },
            managers=[
