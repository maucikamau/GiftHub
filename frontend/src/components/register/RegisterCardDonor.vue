    ...
    <div class="p-8 bg-white text-left h-160 w-150 rounded-xl shadow-lg">
      ...
      <form class="grid grid-cols-2 mb-4">
        ...
        <div>
          ...
          <UInput class="!w-56 ml-2" placeholder="Unesite prezime" />
        </div>
        <div>
          <p class="m-2 font-semibold">
            Korisničko ime
          </p>
          <UInput class="!w-56 ml-2" placeholder="Unesite korisničko ime" />
        </div>
        <div>
          <p class="m-2 font-semibold">
            Mjesto
        ...
        <div>
          <p class="m-2 text-xs">
            Tvoje korisničko ime je <span class="font-semibold">javno</span> i bit će korišteno za komunikaciju sa drugima u chatu.
          </p>
        </div>
        <div>
          <p class="m-2 text-xs">
            Koristimo mjesto za filtriranje oglasa. Ovo ćemo mjesto koristiti kod objave novih oglasa. Uvijek možeš promijeniti mjesto za pojedinačne oglase.
          </p>
        </div>
        ...
        <UButton class="col-span-2 justify-center ml-4 register-btn bg-brand-gradient !mt-3 mb-3" type="submit">
          Registriraj se
        </UButton>
        <RouterLink
          to="/registracija"
